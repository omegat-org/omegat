...
class CommandThread extends Thread
{
	...
	public CommandThread(TransFrame tf)
	{
		...
		m_messageBoardCritSection = new CriticalSection(
						"CommandThread::MessageBoard");
...
//System.out.println("\nsrc text: "+strEntry.getSrcText());
			...
			// tokens take the form of StringData objects
...
//	}
	...
	public String	sourceRoot()	{ return m_config.getSrcRoot();		}
	public String	projName()		{ return m_config.getProjName();	}
	...
	// keep track of file specific data to feed to SourceTextEntry objects
