...
## 0. Pre-announce on an omegat-dev mailing list
...
## 2. Decide a release version

See `/docs_devel/README.txt` for details about a versioning scheme.


## 3. Update files with the release version
