...
when the release engineering, the Step 3, will be started instead of the planed
release date.
...
## 2. Decide bundled JREs versions and Update bundled JREs' major version
...
## 8. Add signature to Windows distribution files locally, publish.
...
## 9. Build a notarized Mac distribution file locally, publish
