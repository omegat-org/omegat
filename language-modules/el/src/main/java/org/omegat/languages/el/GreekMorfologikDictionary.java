...
public class GreekMorfologikDictionary extends AbstractMorfologikDictionary {

    private static final String DICTIONARY_BASE = "/org/languagetool/resource/el/hunspell/";
    private static final String[] MORFOLOGIK = { "el_GR" };
