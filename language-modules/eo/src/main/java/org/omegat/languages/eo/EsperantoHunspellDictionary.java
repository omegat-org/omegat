...
public class EsperantoHunspellDictionary extends AbstractHunspellDictionary {

    private static final String DICTIONARY_BASE = "/org/languagetool/resource/eo/hunspell/";
    private static final String[] DICTIONARY = {"eo"};
