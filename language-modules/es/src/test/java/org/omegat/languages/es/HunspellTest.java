...
public class HunspellTest extends LanguageModuleTestBase {
    ...
    private static final String LANGUAGE = "es_AR";
    private static final String GOOD = "Hola";

    @Test
    public void testDictionary() throws Exception {
        testDictionaryHelper(new LuceneHunSpellChecker(60_000), LANGUAGE, GOOD, null);
    }
}
