...
public class ItalianMorfologikDictionary extends AbstractMorfologikDictionary {

    private static final String DICTIONARY_BASE = "/org/languagetool/resource/it/hunspell/";
    private static final String[] MORFOLOGIK = { "it_IT"};
