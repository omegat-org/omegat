...
public class CentralKhmerHunspellDictionary extends AbstractHunspellDictionary {

    private static final String DICTIONARY_BASE = "/org/languagetool/resource/km/hunspell/";
    private static final String[] HUNSPELL = {"km_KH"};
