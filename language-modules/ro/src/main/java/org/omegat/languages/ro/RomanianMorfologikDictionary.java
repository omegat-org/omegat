...
public class RomanianMorfologikDictionary extends AbstractMorfologikDictionary {

    private static final String DICTIONARY_BASE = "/org/languagetool/resource/ro/hunspell/";
    private static final String[] MORFOLOGIK = { "ro_RO" };
