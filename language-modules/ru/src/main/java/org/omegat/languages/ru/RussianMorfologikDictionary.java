...
public class RussianMorfologikDictionary extends AbstractMorfologikDictionary {

    private static final String DICTIONARY_BASE = "/org/languagetool/resource/ru/hunspell/";
    private static final String[] MORFOLOGIK = { "ru_RU" };
