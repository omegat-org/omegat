...
public class SlovakMorfologikDictionary extends AbstractMorfologikDictionary {

    private static final String DICTIONARY_BASE = "/org/languagetool/resource/sk/hunspell/";
    private static final String[] MORFOLOGIK = { "sk_SK" };
