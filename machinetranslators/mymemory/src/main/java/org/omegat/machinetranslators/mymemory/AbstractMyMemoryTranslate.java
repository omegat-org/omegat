...
public abstract class AbstractMyMemoryTranslate extends BaseCachedTranslate {
    ...
    public void showConfigurationUI(Window parent) {
        ...
        dialog.panel.valueLabel1.setText(BUNDLE.getString("MT_ENGINE_MYMEMORY_EMAIL_LABEL"));
        dialog.panel.valueField1.setText(getCredential(MYMEMORY_API_EMAIL));
        dialog.panel.valueLabel2.setText(BUNDLE.getString("MT_ENGINE_MYMEMORY_API_KEY_LABEL"));
