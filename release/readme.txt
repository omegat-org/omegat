...
OmegaT 1.4.x requires the Java Runtime Environment version 1.4 or higher 
be installed on your system. It is available from http://java.com.
...
- for Unixes (Linux, FreeBSD, MacOSX) type (casesensitive!)
    ./OmegaT
- for Windows type
...
Other contributions by 
  ...
  Samuel Murray
  Dmitry Gabinski
  Raymond Martin (user manual writer) 
