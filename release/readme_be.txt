...
OmegaT.exe. Калі вы бачыце файл OmegaT, але не OmegaT.exe праз дыспэтчар файлаў (Windows Explorer), трэба зьмяніць наладкі такім чынам, каб паказваліся пашырэньні назваў файлаў.
...
OmegaT выкарыстоўвае наступныя бібліятэкі:
  ...
  VLDocking Framework 3.0.4 (ліцэнзія LGPL)
