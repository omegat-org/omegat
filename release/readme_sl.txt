 Ta prevod je delo Vita Smoleja, Copyright © 2008.


==============================================================================
   BeriMe datoteka OmegaT 2.0.0
...
Glavne poteze OmegaT so:
 ...
 OmegaT 1.8.0 sama od sebe podpira prevajanje datotek v naslednjih formatih:
  - enostavno besedilo
  - HTML in XHTML
...
3.2 Namestitev
* uporabniki Windows: treba je samo pognali program za namestitev.  Če želite, vam namestitveni program tudi pripravi bližnjice za OmegaT.
* ostali: najprej si pripravite primeren imenik za OmegaT 
...
* Uporabniki Windows * dvokliknite na datoteko OmegaT.jar. Če v eksplorerju vidite OmegaT, datoteke OmegaT.exe pa ne, popravite nastavitve tako, da boste lahko videli pripone datotek.  
...
* Uporabniki Windows program za namestitev lahko pripravi bližnjice na namizju in na območju za 'Hitri zagon'. Lahko tudi povlečete datoteko OmegaT.exe na omizje ali območje za hitri zagon ter v začetni meni, da vam bo OmegaT tam na razpolago.
...
Desnokliknite na pano - dodaj nov zagon. Vtipkajte "OmegaT" v polje "Ime"; V polju "Ukaz" poiščite z gumbom za navigacijo vaš skript za zagon OmegaT. Izberite ga. in kliknite V redu.
...
OmegaT uporablja naslednje knjižnice:
  ...
  MRJ Adapter 1.0.8 - Steve Roy (LGPL Licenca)
  ...
  JAXB (GPLv2 + izjema za pot klase)
