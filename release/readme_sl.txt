...
Priročnik za uporabnika se nahaja v paketu, ki ste ga ravnokar prenesli, ob zagonu OmegaT vam bo na razpolago prek menija / pomoč.
...
Uporabniki Windows in Linux: če ste prepričani, da se na vašem sistemu ustrezni JRE že nahaja, lahko naložite OmegaT brez JRE (instalacijo prepoznate po imenu, ki vsebuje oznako "Without_JRE"). V kolikor niste čisto prepričani, vam priporočamo uporabo verzije "standard", to je vključno z JRE. Tako ste na varnem tudi v primeru, če se na vašem računalniku JRE že nahaja, saj se verziji med seboj ne bosta motili.
...
* Dvokliknite na datoteko OmegaT.bat. Če v raziskovalcu vidite OmegaT, ne pa datoteke OmegaT.bat, popravite nastavitve tako, da bo videti pripone datotek. 
...
Datoteka, s katero se Java izvaja, se imenuje java.exe. Če je Java nameščena in konfigurirana na nivoju sistema, polna pot ni potrebna in zadošča, če vtipkate enostavno java. Če hočete, lahko povlečete datoteke OmegaT-JRE.exe, OmegaT.exe ali OmegaT.bat na omizje ali pa v začetni meni, da vam bo OmegaT tam na razpolago.
...
Datoteka, s katero se Java izvaja, je datoteka java. Če je Java nameščena in konfigurirana na nivoju sistema, polna pot ni potrebna.
...
Desnokliknite na pano - dodaj nov zagon. V polje "ime" vtipkajte OmegaT, za polje "ukaz" poiščite z gumbom za navigacijo vaš skript za zagon OmegaT. Izberite ga in kliknite V redu.
...
(Če ste mnenja, da ste k projektu OmegaT Project pomembno prispevali, pa na seznamu svojega imena ne najdete, se prosim obrnite na nas.)
