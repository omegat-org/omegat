Scripts included in the OmegaT distribution are here for the user's convenience only. Scripts are not to be considered part of OmegaT. They are not tested by OmegaT developers and it is the authors' responsibility to maintain them. If an author is unable or unwilling to fix a script, the script will be removed from the distribution.
