...
2. Optionally pack more sync cycles into a shorter run with `-Domegat.test.delay=X` where X is
   the maximum number of seconds a simulated translator waits between edits (default is 15s)
3. Wait
4. Check the result
