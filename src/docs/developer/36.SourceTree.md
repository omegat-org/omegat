...
### module distribution wiring

Module jars reach the distribution through producer/consumer configurations
declared per subproject:

![Module jars as declared dependencies](assets/module-dist-wiring-slide2.svg)

Relative jar sizes of the shipped modules, as a historic snapshot at one
certain point of time in the past (the numbers are not maintained):

![Treemap of language module jar sizes and duplicate third-party cargo](assets/module-size-treemap.svg)
