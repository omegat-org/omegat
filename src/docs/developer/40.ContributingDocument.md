...
When developer documentation grows beyond a short explanation, create a dedicated
source file in `src/docs/developer`, for example `48.DeveloperDocumentation.md`,
and add it to the developer documentation index.
Keeping large topics in separate files makes reviews easier and helps readers find
architecture notes, contributor guidance, and tool-specific documentation.

See [Developer documentation](48.DeveloperDocumentation.md) for information about
the developer documentation structure, the Sphinx documentation system,
Read the Docs configuration, and diagram authoring with SVG and Mermaid.
...
Documentation contribution follows the same rules are code contributions. See [Contributing to OmegaT development](02.ContributingEcoSystem.md) for more information.
