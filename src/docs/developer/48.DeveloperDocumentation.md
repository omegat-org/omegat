...
The `scripts` directory contains helper scripts for developer documentation.

Use this directory for scripts that support documentation maintenance, generation,
checking, or analysis. Scripts should be documented well enough that contributors
can understand when and how to run them.

When adding a script:

- use a descriptive file name
- include comments or command-line help
- avoid unnecessary external dependencies
- document required dependencies
- keep generated output out of version control unless it is intentionally tracked

If a script is required by the documentation build, make sure the build
environment installs its dependencies and that the usage is documented.
