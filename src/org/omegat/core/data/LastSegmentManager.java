...
public final class LastSegmentManager {
    ...
    private static final System.Logger LOGGER = System.getLogger(LastSegmentManager.class.getName());
    ...
    public static void saveLastSegment() {
        ...
        try {
            ...
            LOGGER.log(System.Logger.Level.WARNING, "Could not write the last entry number: {0}",
                    e.getMessage());
        } finally {
            if (fos != null) {
                try {
