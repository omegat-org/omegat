...
public class RealProject implements IProject
{
            ...
            throws IOException, TranslationException
    {
        ...
        try
        {
            Map<String,String> tmx = TMXWriter.prepareTMXData(m_strEntryList, null, false, null);
    ...
    private void forceSave(boolean corruptionDanger)
    {
        ...
        try
        {
            ...
            Map<String,String> tmx = TMXWriter.prepareTMXData(m_strEntryList, m_orphanedList, false, null);            
