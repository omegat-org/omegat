...
class MTHUBTranslateRequest{
    ...
    public MTHUBTranslateRequest(String token, String source, String target, ArrayList<String> segments) {
        this.token = token;
        this.source = source;
        this.target = target;
...
public class MTHUBTranslate extends BaseTranslate{
    ...
    private void setAvailableLanguageCodes() {
       ...
       try { 
            ...
            in.close();
            this.AVAILABLE_LANGUAGE_CODES = getJsonCodes(codesMTHUB);            
    ...
    protected String translate(Language sLang, Language tLang, String text) throws Exception {
        ...
        {            
            ...
            MTHUBTranslateRequest mttr = new MTHUBTranslateRequest(MTHUBKey, getNormaliseCode(sLang), getNormaliseCode(tLang), segments);
        ...
        catch(MalformedURLException e)
        {
            ...
            if(e.getMessage().contains("401")){
                return StringUtil.format(OStrings.getString("MTHUB_ERROR"), 401 , OStrings.getString("MT_ENGINE_MTHUB_INVALID_KEY"));
            }else if(e.getMessage().contains("400")){
                return StringUtil.format(OStrings.getString("MTHUB_ERROR"), 400, OStrings.getString("MT_ENGINE_MTHUB_MISSING_PARAMETERS"));
            }else if(e.getMessage().contains("500")){
                return StringUtil.format(OStrings.getString("MTHUB_ERROR"), 500, OStrings.getString("MT_ENGINE_MTHUB_INVALID_LANG_CODE"));
            }else{
    ...
    protected String getJsonResults(Map<String, Object> rootNode) {
        ...
        if (rootNode.containsKey("error") && rootNode.get("error") != null) {
            ...
            case 401:
                     tr=StringUtil.format(OStrings.getString("MTHUB_ERROR"), (int)error.get("code"), OStrings.getString("MT_ENGINE_MTHUB_INVALID_KEY"));
                     break;
            case 400:
                    switch ((int)error.get("code")) {
                        case 4:
                            tr=StringUtil.format(OStrings.getString("MTHUB_ERROR"), (int)error.get("code"), OStrings.getString("MT_ENGINE_MTHUB_INVALID_DOMAIN"));
                            break;
                        case 11:
                            tr=StringUtil.format(OStrings.getString("MTHUB_ERROR"), (int)error.get("code"), OStrings.getString("MT_ENGINE_MTHUB_MISSING_KEY"));
                            break;
                        case 17:
                            tr=StringUtil.format(OStrings.getString("MTHUB_ERROR"), (int)error.get("code"), OStrings.getString("MT_ENGINE_MTHUB_MISSING_SEGMENTS"));
                            break;                         
                        default:
                            tr=StringUtil.format(OStrings.getString("MTHUB_ERROR"), (int)error.get("code"), OStrings.getString("MT_ENGINE_MTHUB_MISSING_PARAMETERS"));
                            break;
                    }
                    break;
            case 500:
                switch ((int)error.get("code")) {
                        case 19:
                            tr=StringUtil.format(OStrings.getString("MTHUB_ERROR"), (int)error.get("code"), OStrings.getString("MT_ENGINE_MTHUB_INVALID_LANG_CODE"));
                            break;                                             
                        default:
                            tr=StringUtil.format(OStrings.getString("MTHUB_ERROR"), (int)error.get("code"), OStrings.getString("MT_ENGINE_MTHUB_MISSING_PARAMETERS"));
                            break;
                    ...
                    break;                
            default:
                    tr=StringUtil.format(OStrings.getString("MTHUB_ERROR"), 1, (String)error.get("message"));
                    break;
            }
        }
