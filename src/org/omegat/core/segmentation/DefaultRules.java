...
public class DefaultRules
{
    ...
    public static List<Rule> german()
    {
        ...
        srules.add(new Rule(false, "�sterr\\.", "\\s"));                        // NOI18N
        ...
        srules.add(new Rule(false, "r\\.-k\\.", "\\s"));                        // NOI18N
        srules.add(new Rule(false, "r�m\\.", "\\s"));                           // NOI18N
        srules.add(new Rule(false, "r�m\\.-kath\\.", "\\s"));                   // NOI18N
        ...
        srules.add(new Rule(false, "schw�b\\.", "\\s"));                        // NOI18N
        ...
        srules.add(new Rule(false, "s�dd\\.", "\\s"));                          // NOI18N
        srules.add(new Rule(false, "t�gl\\.", "\\s"));                          // NOI18N
        ...
        srules.add(new Rule(false, "j�hrl\\.", "\\s"));                         // NOI18N
        ...
        srules.add(new Rule(false, "�kol\\.", "\\s"));                          // NOI18N
        ...
        srules.add(new Rule(false, "m�nnl\\.", "\\s"));                         // NOI18N
        srules.add(new Rule(false, "i\\.a\\.", "\\s"));                         // NOI18N
        ...
        srules.add(new Rule(false, "\\sM�r\\.", "\\s"));                        // NOI18N
