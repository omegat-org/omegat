...
public class RemoteRepositoryProvider {
    private static final System.Logger LOGGER = System.getLogger(RemoteRepositoryProvider.class.getName());
    ...
    public void switchAllToLatest() throws Exception {
        ...
        for (IRemoteRepository2 r : repositories) {
            try {
                ...
                errors.add(e);
                LOGGER.log(System.Logger.Level.ERROR, OStrings.getResourceBundle(), "TEAM_UPDATE_REPO_ERROR",
                        e.getMessage());
            }
        }
    ...
    class Mapping {
        ...
        private void deleteFile(File f) {
            ...
            try {
                ...
                LOGGER.log(System.Logger.Level.WARNING, "LOG_ERROR_DELETE_FILE", f);
            }
        }
    }
}
