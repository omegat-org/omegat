            ...
            throws IOException, TranslationException
    {
        ...
        while( (i = getNextChar(reader))>=0 )
        {
            ...
            else if (c=='&' || c==' ' || c == 10 || c == 13 || ctr > 10)
            {
                ...
                for(int n=pushing.length()-1; n>=0; n--)
                    pushNextChar(pushing.charAt(n));
                pushNextChar(c);
        ...
        if (c == 0)
            throw new IOException(
                    MessageFormat.format(
                        OStrings.getString("HFH_ERROR_UNRECOGNIZED_ESCAPE_CHAR"),
                        new Object[]{ ""+nextChar_line }) + "\n " + buf.string());    // NOI18N
        return c;
    }
            ...
            throws IOException, TranslationException
    {
        ...
        try
        {
            while ((i = getNextChar(reader)) >= 0)
            {
                ...
                // handle errorneus < more carefully
                try
                {
                    if (c == '<')
                    {
                ...
                // eat silently, will treat < as text
            ...
            switch (c)
            {
                ...
                case 0:
                    ...
                    throw new TranslationException(
                            ...
                            new Object[]{ ""+nextChar_line })); // NOI18N
                default:
                    ...
                    switch (charType)
                    {
                        ...
                        default:
                            throw new TranslationException(
                                    ...
                                    new Object[] { tag.verbatum().string(), ""+nextChar_line })); // NOI18N
                    }
                    break;
