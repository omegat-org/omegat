...
public class FilterVisitor extends NodeVisitor
{
    ...
    private boolean isParagraphTag(Tag tag)
    {
        ...
        return
                ...
                tagname.equals("ADDRESS") ||                                    
                tagname.equals("BLOCKQUOTE") ||                                 
                tagname.equals("BODY") ||                                       
                tagname.equals("CENTER") ||                                     
                tagname.equals("DIV") ||                                        
                tagname.equals("H1") || tagname.equals("H2") ||                 
                    tagname.equals("H3") || tagname.equals("H4") ||             
                    tagname.equals("H5") || tagname.equals("H6") ||             
                tagname.equals("HTML") ||                                       
                tagname.equals("HEAD") || tagname.equals("TITLE") ||            
                tagname.equals("TABLE") || tagname.equals("TR") ||              
                    tagname.equals("TD") || tagname.equals("TH") ||             
                tagname.equals("P") ||                                          
                tagname.equals("PRE") ||                                        
                tagname.equals("OL") || tagname.equals("UL") ||                 
                    tagname.equals("LI") ||                                     
                // Added by JC to have dictionary list parsed as segmenting.
                tagname.equals("DL") ||                                         
                     tagname.equals("DT") || tagname.equals("DD") ||            
                // End of JC's contribution
                tagname.equals("FORM") || tagname.equals("TEXTAREA") ||         
                tagname.equals("FIELDSET") || tagname.equals("LEGEND") ||       
                tagname.equals("LABEL")                                         
                || tagname.equals("SELECT") || tagname.equals("OPTION") ||      
                tagname.equals("HR") ||                                         
    ...
    private static final Object ENTITIES[][] =
    {
        ...
        //  Latin Extended-A
        {"OElig", new Integer(338)},                           // latin capital ligature OE, U+0152 ISOlat2
        {"oelig", new Integer(339)},                           // latin small ligature oe, U+0153 ISOlat2
        //  ligature is a misnomer, this is a separate character in some languages
        {"Scaron", new Integer(352)},                           // latin capital letter S with caron, U+0160 ISOlat2
        {"scaron", new Integer(353)},                           // latin small letter s with caron, U+0161 ISOlat2
        {"Yuml", new Integer(376)},                           // latin capital letter Y with diaeresis, U+0178 ISOlat2

        //  Spacing Modifier Letters
        {"circ", new Integer(710)},                           // modifier letter circumflex accent, U+02C6 ISOpub
        ...
        {"zwnj", new Integer(8204)},                           // zero width non-joiner, U+200C NEW RFC 2070
        {"zwj", new Integer(8205)},                           // zero width joiner, U+200D NEW RFC 2070
        {"lrm", new Integer(8206)},                           // left-to-right mark, U+200E NEW RFC 2070
        {"rlm", new Integer(8207)},                           // right-to-left mark, U+200F NEW RFC 2070
        {"ndash", new Integer(8211)},                           // en dash, U+2013 ISOpub
        {"mdash", new Integer(8212)},                           // em dash, U+2014 ISOpub
        {"lsquo", new Integer(8216)},                           // left single quotation mark, U+2018 ISOnum
        {"rsquo", new Integer(8217)},                           // right single quotation mark, U+2019 ISOnum
        {"sbquo", new Integer(8218)},                           // single low-9 quotation mark, U+201A NEW
        {"ldquo", new Integer(8220)},                           // left double quotation mark, U+201C ISOnum
        {"rdquo", new Integer(8221)},                           // right double quotation mark, U+201D ISOnum
        {"bdquo", new Integer(8222)},                           // double low-9 quotation mark, U+201E NEW
        ...
        {"lsaquo", new Integer(8249)},                           // single left-pointing angle quotation mark, U+2039 ISO proposed
                                       //  lsaquo is proposed but not yet ISO standardized
        {"rsaquo", new Integer(8250)},                           // single right-pointing angle quotation mark, U+203A ISO proposed
