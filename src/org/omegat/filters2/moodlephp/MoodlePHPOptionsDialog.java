...
public class MoodlePHPOptionsDialog extends javax.swing.JDialog {
     ...
     */
    public MoodlePHPOptionsDialog(Window parent, Map<String, String> options) {
        super(parent);
        setModal(true);
        this.options = new TreeMap<String, String>(options);
        initComponents();

        String removeStringsUntranslated = options.get(MoodlePHPFilter.OPTION_REMOVE_STRINGS_UNTRANSLATED);
    ...
    private void initComponents() {
        ...
        setTitle(OStrings.getString("MOODLEPHP_FILTER_OPTIONS_TITLE")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(removeStringsUntranslatedCB, OStrings.getString("MOODLEPHP_FILTER_REMOVE_STRINGS_UNTRANSLATED")); // NOI18N
...
private void okButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okButtonActionPerformed
        options.put(MoodlePHPFilter.OPTION_REMOVE_STRINGS_UNTRANSLATED, Boolean.toString(removeStringsUntranslatedCB.isSelected()));
        doClose(RET_OK);
