...
public class ResourceBundleOptionsDialog extends javax.swing.JDialog {
    ...
    public ResourceBundleOptionsDialog(Window parent, Map<String, String> options) {
        ...
        String removeStringsUntranslated = options
                .get(ResourceBundleFilter.OPTION_REMOVE_STRINGS_UNTRANSLATED);
    ...
    private void initComponents() {
        ...
        org.openide.awt.Mnemonics.setLocalizedText(removeStringsUntranslatedCB,
                OStrings.getString("RB_FILTER_REMOVE_STRINGS_UNTRANSLATED")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(dontUnescapeULiteralsCB,
                bundle.getString("RB_FILTER_NOT_CONVERT_UNICODE_CHARACTERS")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        org.openide.awt.Mnemonics.setLocalizedText(supportJava8EncodingCB,
                OStrings.getString("RB_FILTER_SUPPORT_JAVA8_ENCODING")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
    ...
    private void okButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_okButtonActionPerformed
        options.put(ResourceBundleFilter.OPTION_REMOVE_STRINGS_UNTRANSLATED,
                Boolean.toString(removeStringsUntranslatedCB.isSelected()));
        options.put(ResourceBundleFilter.OPTION_DONT_UNESCAPE_U_LITERALS,
                Boolean.toString(dontUnescapeULiteralsCB.isSelected()));
        options.put(ResourceBundleFilter.OPTION_FORCE_JAVA8_LITERALS_ESCAPE,
                Boolean.toString(supportJava8EncodingCB.isSelected()));
        doClose(RET_OK);
