 ...
 * The DokuWiki save it content in *.txt files
 *
...
public class DokuWikiFilter extends AbstractFilter
{
    ...
    /**
     * Check if there are data to translate in the StringBuilder. If yes then it translate it and reset the
     * StringBuilder.
     * 
     * @param outfile
