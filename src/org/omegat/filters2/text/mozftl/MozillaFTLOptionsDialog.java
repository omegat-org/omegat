 ...
 *
 * Code refactored from the file: ResourceBundleOptionsDialog.java
 *
 * @author Enrique Estevez (keko.gl@gmail.com)
 */
@SuppressWarnings("serial")
public class MozillaFTLOptionsDialog extends javax.swing.JDialog {
    ...
    public MozillaFTLOptionsDialog(Window parent, Map<String, String> options) {
        ...
        String removeStringsUntranslated = options.get(MozillaFTLFilter.OPTION_REMOVE_STRINGS_UNTRANSLATED);
    ...
    private void initComponents() {
        ...
        setTitle(OStrings.getString("MOZFTL_FILTER_OPTIONS_TITLE")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(removeStringsUntranslatedCB, OStrings.getString("MOZFTL_FILTER_REMOVE_STRINGS_UNTRANSLATED")); // NOI18N
...
private void okButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okButtonActionPerformed
        options.put(MozillaFTLFilter.OPTION_REMOVE_STRINGS_UNTRANSLATED, Boolean.toString(removeStringsUntranslatedCB.isSelected()));
        doClose(RET_OK);
