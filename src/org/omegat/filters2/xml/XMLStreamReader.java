...
public class XMLStreamReader
{
     ...
     */
    private XMLBlock getNextTagExclamation()
            throws TranslationException
	{
     ...
     */
	public ArrayList closeBlock(XMLBlock block, boolean includeTerminationBlock)
            throws TranslationException
	{
	...
	public XMLBlock advanceToTag(String tagname)
            throws TranslationException
	{
		XMLBlock blk;
		while (true)
