 ...
 * @author Didier Briel
 */
public class ScribusFilter extends XMLFilter {

    /**
     * Creates a new instance of Infix
     */
    public ScribusFilter() {
        super(new ScribusDialect());
    }
    ...
    public String getFileFormatName() {
        return OStrings.getString("SCRIBUS_FILTER_NAME");
    }
    ...
    public Instance[] getDefaultInstances() {
        return new Instance[] { new Instance("*.sla") };
    }
