...
public abstract class BaseMainWindowMenu implements ActionListener, MenuListener, IMainMenu {
    ...
    protected void createComponents() {
        ...
        projectTeamNewMenuItem = createMenuItem(PROJECT_NEW_TEAM_MENUITEM,
                "TF_MENU_FILE_TEAM_CREATE");
        projectOpenMenuItem = createMenuItem(PROJECT_OPEN_MENUITEM, "TF_MENU_FILE_OPEN");
        projectOpenRecentMenuItem = createMenu(PROJECT_OPEN_RECENT_SUBMENU,
                "TF_MENU_FILE_OPEN_RECENT", null);
        ...
        viewDisplayModificationInfoNoneRadioButtonMenuItem =
                createRadioButtonMenuItem(VIEW_DISPLAY_MODIFICATION_INFO_NONE_RADIO_BUTTON,
        ...
        optionsAutoCompleteMenu = createMenu(OPTIONS_AUTOCOMPLETE_SUBMENU,
                "MW_OPTIONSMENU_AUTOCOMPLETE");
