...
public final class PluginManager {
    ...
    /**
     * Loads plugins for the application. This overloaded method provides a simplified
     * interface for loading plugins without requiring any custom parameters.
     * It delegates to the main plugin loading method with a null parameter, which
     * initializes plugin locations, class loaders, and processes plugin manifests
     * to load plugins.
     */
     ...
     *
     */
    public static void loadPlugins(final String devManifests) {
        ...
        try {
            ...
            processManifest(devManifests, isMainManifestFound);
            loadBasePlugin();
     ...
     */
    private static void processManifest(String manifests, boolean foundMain) {
        MainClassLoader pluginsClassLoader = MAINCLASSLOADERS.get(PluginType.UNKNOWN);
        try {
            if (!foundMain) {
                if (manifests != null) {
