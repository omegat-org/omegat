 ...
 * Lucene library, utilizing the {@link ItalianAnalyzer} when stemming is
...
public class LuceneItalianTokenizer extends BaseTokenizer {
    ...
    protected TokenStream getTokenStream(final String strOrig, final StemmingMode stemmingMode,
        ...
        CharArraySet stopWords = stopWordsAllowed ? ItalianAnalyzer.getDefaultStopSet()
        ...
        case MATCHING_FULL:
            return new SnowballFilter(
                    new ItalianAnalyzer(stopWords).tokenStream("", new StringReader(strOrig)),
                    new ItalianStemmer());
        default:
