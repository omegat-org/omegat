...
public final class HTMLUtils {
     ...
     *             if an I/O error occurs while reading from the stream.
     */
    private static @NotNull Charset detectEncodingFromContent(BufferedInputStream inputStream,
     ...
     *         found
     */
    private static @Nullable Charset detectCharset(String content, Pattern... patterns) {
