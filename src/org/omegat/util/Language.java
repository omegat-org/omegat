...
public class Language
{
    ...
    public String toString()
    {
        ...
        else
        {
            ...
            if( !"".equals(locale.getCountry()) )
                localestring += "-"+locale.getCountry().toUpperCase();
            return localestring;
        }
    }
    ...
    public static final Language[] LANGUAGES = new Language[]
    {
        ...
        new Language("ru-MD"),       // Russian (Moldova)
        new Language("ru-RU"),       // Russian (Russia)
        new Language("ru-UA"),       // Russian (Ukraine)
        ...
        new Language("sr"),       // Serbo-Croatian
        new Language("sh-YU"),       // Serbo-Croatian (Yugoslavia)
        ...
        new Language("zh-CN"),       // Chinese (China)
        new Language("zh-HK"),       // Chinese (Hong Kong)
        new Language("zh-TW"),       // Chinese (Taiwan)
