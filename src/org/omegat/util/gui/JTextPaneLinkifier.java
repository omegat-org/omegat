...
public class JTextPaneLinkifier {
    ...
    private static class AttributeInserterDocumentFilter extends DocumentFilter {
        ...
        private static final long REFRESH_DELAY = 2L;
        ...
        public AttributeInserterDocumentFilter(final StyledDocument doc) {
            // refresh thread
            this.executorService = new ScheduledThreadPoolExecutor(1);
            this.refreshRun = new RefreshRunnable(doc);
        }
        ...
        private static class RefreshRunnable implements Runnable {
            ...
            public RefreshRunnable(StyledDocument doc) {
                this.doc = doc;
            }
