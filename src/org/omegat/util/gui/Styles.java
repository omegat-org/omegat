...
public final class Styles {
    private static final System.Logger LOGGER = System.getLogger(EditorColor.class.getName());
        ...
        EditorColor(Color defaultColor) {
            ...
            if (prefColor != null && !DEFAULT_COLOR.equals(prefColor)) {
                try {
                    ...
                    LOGGER.log(System.Logger.Level.DEBUG, "Cannot set custom color for {0}, default to {1}.",
                            name(), prefColor);
                }
            }
        }
