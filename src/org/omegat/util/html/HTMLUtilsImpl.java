...
public class HTMLUtilsImpl {
    ...
    public String charsToEntities(String str, String encoding, Collection<String> shortcuts) {
    ...
    public Charset detectEncoding(String fileName, String defaultEncoding) {
        Charset fallbackCharset = defaultEncoding == null ? Charset.defaultCharset()
                : Charset.forName(defaultEncoding);
        Charset encoding = null;
        try (BufferedInputStream inputStream = new BufferedInputStream(new FileInputStream(fileName))) {
            encoding = detectBOM(inputStream);
            if (encoding == null) {
                encoding = detectEncodingFromContent(inputStream, fallbackCharset);
            }
        } catch (IOException ignored) {
            // ignore exceptions
        }
        return encoding != null ? encoding : fallbackCharset;
    }
    ...
    private int handleHexEntity(String input, int startIndex, int inputLength, StringBuilder result) {
        ...
        int endOffset = findEndOfDigits(input, startOffset, inputLength, ch -> isHexDigit(ch));
    ...
    private int handleDecimalEntity(String input, int startIndex, int inputLength, StringBuilder result) {
        ...
        int endOffset = findEndOfDigits(input, startOffset, inputLength, ch -> isDecimalDigit(ch));
    ...
    public String getSpacePrefix(String input, boolean compressWhitespace) {
    ...
    public String getSpacePostfix(String input, boolean compressWhitespace) {
        int size = input.length();
        int i = size;
        while (i > 0) {
     ...
     *             if an I/O error occurs while reading from the stream.
     */
    private @NotNull Charset detectEncodingFromContent(BufferedInputStream inputStream,
        ...
        String content = new String(buffer, 0, length, fallbackCharset);
        Charset encoding = detectCharset(content, PatternConsts.HTML_ENCODING, PatternConsts.HTML5_ENCODING,
     ...
     *         found
     */
    private @Nullable Charset detectCharset(String content, Pattern... patterns) {
