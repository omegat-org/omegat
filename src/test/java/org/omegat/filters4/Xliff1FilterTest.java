...
public class Xliff1FilterTest extends org.omegat.filters.TestFilterBase {
    ...
    public void testTranslation() throws Exception {
        ...
        translate(filter, "src/test/resources/data/filters/xliff/filters4-xliff1/en-xx.xlf");
    ...
    public void testBugs418() throws Exception {
        Xliff1Filter filter = new Xliff1Filter();
        translateXML(filter,
                "src/test/resources/data/filters/xliff/filters3/file-XLIFFFilter-cdata-bugs418.xlf");
    }
    ...
    public void testBugs1247() throws Exception {
        Xliff1Filter filter = new Xliff1Filter();
        translateXML(filter,
                "src/test/resources/data/filters/xliff/filters4-xliff1/file-XLIFFFilter1-multiple-file-tag.xlf");
    }

    @Test
    public void testBugs1247_2() throws Exception {
        String f = "src/test/resources/data/filters/xliff/filters4-xliff1/file-XLIFFFilter1-multiple-file-tag.xlf";
        Xliff1Filter filter = new Xliff1Filter();
