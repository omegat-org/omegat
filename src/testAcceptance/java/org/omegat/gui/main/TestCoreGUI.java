...
public abstract class TestCoreGUI extends AssertJSwingJUnitTestCase {
    ...
    private static final String PLUGINS_LIST_FILE = "src/testAcceptance/resources/plugins.properties";
    ...
    private static void initializeOmegaTCore() throws Exception {
        ...
        FileUtils.copyDirectory(new File("src/testAcceptance/resources/data/config"), configTmp.toFile());
