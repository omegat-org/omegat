...
- **Option B: Pull request (PR)**  
  Fork the OmegaT project on GitHub and open a PR from your fork. See [Filling Pull Request Forms](09.FillingPullRequestForms.md) for guidance on how to fill out the PR form.
