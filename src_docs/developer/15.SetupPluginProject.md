...
You can use the skeleton project as a project template forked from [https://github.com/omegat-org/plugin-skeleton](https://github.com/omegat-org/plugin-skeleton)
