...
## Status
**Implementation fully implemented** (Date: 2026-07-10)
- Pull Requests:
    - [PR#1570](https://github.com/omegat-org/omegat/pulls/1570/)
    - [PR#1577](https://github.com/omegat-org/omegat/pulls/1577/)
- Related Threads:
...
[#PR1577](https://github.com/omegat-org/omegat/pull/1577) implements this option, by extending `ProjectTMX#save` 
...
- [OmegaT PR#1569 - fix(test): make TMX test data to be compliant with TMX1.1 and 1.4](https://github.com/omegat-org/omegat/pull/1569)
- [OmegaT PR#1570 - refactor(core): add TMXLSResourceResolver and improve TMX validation in TMXReader2](https://github.com/omegat-org/omegat/pull/1570)
- [OmegaT PR#1577 - Project tmx level2](https://github.com/omegat-org/omegat/pull/1577)
