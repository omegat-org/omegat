...
**Approach**: Integrate directly with specific IDEs (IntelliJ, Eclipse, VSCode)
**Rejected**: Would limit accessibility. DAP's universal protocol support can work across VSCode, Emacs, Vim/Neovim, Sublime Text, and numerous other editors without requiring separate integrations. 
...
- [PR #1715 refactor(scripting): structured features with runner and ui packages](https://github.com/omegat-org/omegat/pull/1715)
- [PR #1703 refactor(scripting): introduce scripting function as a module](https://github.com/omegat-org/omegat/pull/1703)
