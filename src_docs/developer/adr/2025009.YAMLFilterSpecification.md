...
- term: `Welcome` comment: `title`
- term: `Home` comment: `menu.items[0]`
- term: `About` comment: `menu.items[1]`
- term: `Contact` comment: `menu.items[2]`
- term: `(c) 2025 Example Co.` comment: `footer.copyright`
