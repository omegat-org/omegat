...
This enables connector plugins to perform quality checks that consider project-level instructions and provide detailed rationale for identified issues.
...
✅ **Contextual Quality**: Enables higher-quality translations and better issue detection by providing the necessary context to plugins.
