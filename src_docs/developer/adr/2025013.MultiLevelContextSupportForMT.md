...
## Optional Note: Reference Implementation (MT/MCP/OpenAI connector Plugin)
...
Some users have expressed interest in using Large Language Models for machine translation, specifically local LLMs to ensure data privacy and avoid recurring costs.
...
The plugin can provide a generic connector for OpenAI-compatible APIs (Ollama, LM Studio, OpenAI, etc.) and dedicated connectors for other services (Azure, Google, DeepL, etc.).
