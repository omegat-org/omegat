...
import org.omegat.core.team2.AbstractRemoteRepository2IT;
import org.omegat.core.team2.IRemoteRepository2;

public final class GitRemoteRepository2IT extends AbstractRemoteRepository2IT {

    @Override
    public void prepareLocalRepo() throws IOException, GitAPIException {
    ...
    @Override
    public IRemoteRepository2 getRr2() {
        GITRemoteRepository2.loadPlugins();
        return new GITRemoteRepository2();
    }

    @Override
    public void configureRepositoryDefinition() {
    ...
    public String toRr2Notation(String file) {
        //on windows, we still have to use '/' as separator, because jgit requires that.
        return file.replace(File.separator, "/");
    }

    @Override
    public void assertFileOrDirDeleted(String dir, String fileInDir, String actual) {
