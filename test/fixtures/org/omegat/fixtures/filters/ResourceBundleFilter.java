/*******************************************************************************
  ...
  Copyright (C) 2000-2024 Hiroshi Miura
 ...
 * Java applications (for test stub).
 *
...
public class ResourceBundleFilter extends AbstractFilter {
    ...
    public Instance[] getDefaultInstances() {
        return new Instance[] { new Instance("*.properties", DEFAULT_SOURCE_ENCODING, DEFAULT_TARGET_ENCODING,
                AbstractFilter.TFP_NAMEONLY + "_" + AbstractFilter.TFP_TARGET_LOCALE + "." + AbstractFilter.TFP_EXTENSION) };
    }
