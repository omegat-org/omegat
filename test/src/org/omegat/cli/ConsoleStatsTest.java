...
public class ConsoleStatsTest extends ConsoleTestsCommon {
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][] { { "text", "Project Statistics", AssertionType.CONTAINS },
                ...
                { "xml", "<omegat-stats>", AssertionType.LINE_2 } });
    }

    private enum AssertionType {
        CONTAINS, STARTS_WITH, LINE_2
    }
    ...
    public void testConsoleStatsLegacy() throws Exception {
        ...
        case STARTS_WITH:
            ...
            break;
        case LINE_2:
            assertTrue(lines.get(1).startsWith(expectedContent));
            break;
        case CONTAINS:
            assertTrue(lines.contains(expectedContent));
            break;
        default:
