...
public class DokuWikiFilterTest extends TestFilterBase {
    ...
    public void testIsFileSupported() {
        ...
        assertTrue( filter.isFileSupported( new File("test/data/filters/dokuwiki/dokuwiki.txt"), null, new TreeMap<String, String>() ) );
        assertFalse( filter.isFileSupported( new File("test/data/filters/text/text1.txt"), null, new TreeMap<String, String>() ) );
    }
