...
public class ILIASFilterTest extends TestFilterBase {
    ...
    public void testAlign() throws Exception {
        ...
        align(new ILIASFilter(), Paths.get("test/data/filters/ilias/ILIASFilterAlign.lang").toAbsolutePath().toFile(),
                Paths.get("test/data/filters/ilias/ILIASFilterAlign-tr.lang").toAbsolutePath().toFile(),
