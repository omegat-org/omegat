...
public class DefaultFlatLightTheme extends FlatLaf {
    ...
    private static UIDefaults setLightDefaults(UIDefaults defaults) {
        ...
        defaults.put(EditorColor.COLOR_REMOVETEXT_TARGET.getUIManagerKey(), new Color(0xff0000));
        ...
        defaults.put(EditorColor.COLOR_TERMINOLOGY.getUIManagerKey(), new Color(0xff6600));
        defaults.put(EditorColor.COLOR_MATCHES_CHANGED.getUIManagerKey(), new Color(0x0000ff));
        defaults.put(EditorColor.COLOR_MATCHES_UNCHANGED.getUIManagerKey(), new Color(0x00ff00));
        defaults.put(EditorColor.COLOR_MATCHES_INS_ACTIVE.getUIManagerKey(), new Color(0x0000ff));
        defaults.put(EditorColor.COLOR_MATCHES_INS_INACTIVE.getUIManagerKey(), new Color(0x808080));
        ...
        defaults.put(EditorColor.COLOR_SEARCH_REPLACE_MARK.getUIManagerKey(), new Color(0xff9900));
